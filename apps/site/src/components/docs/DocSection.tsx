...
export const code: CSSProperties = { backgroundColor: '#f4f4f5', borderRadius: '0 0 8px 8px', padding: '16px', paddingRight: '40px', fontSize: '12px', color: '#1c1c1c', lineHeight: '1.8', display: 'block', overflowX: 'auto' }
